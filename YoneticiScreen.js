// ============================================================
// YUMURCAK — YoneticiScreen.js
// Yönetici ana ekranı — yakında gelecek
// ============================================================

import { View, Text, TouchableOpacity, StyleSheet, SafeAreaView } from 'react-native';
import { RENKLER } from '../constants';

export function YoneticiEkrani({ kullanici, kres, cikisYap }) {
  return (
    <SafeAreaView style={s.con}>
      <View style={s.ic}>
        <Text style={s.emoji}>👑</Text>
        <Text style={s.baslik}>Yönetici Paneli</Text>
        ...
        <Text style={{ color: RENKLER.altMetin, marginTop: 20 }}>
          Yakında burada öğretmen ve çocuk yönetimi olacak 🚀
        </Text>
