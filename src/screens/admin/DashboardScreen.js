...
const MENU_ITEMS = [
  ...
  { title: 'Aylık Bülten', icon: '📰', screen: 'AdminMonthlyBulletin', desc: 'Kurum geneli haber bülteni', color: THEME.teal, bgColor: '#E0F7FA' },
  ...
  { title: 'Gezi Formu', icon: '🚏', screen: 'AdminGeziFormList', desc: 'Gezi/etkinlik izin formları', color: THEME.green, bgColor: '#E7FAD9' },
