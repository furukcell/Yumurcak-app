...
const styles = StyleSheet.create({
  ...
  birthDate: { fontSize: 14, color: '#712B13', fontWeight: '500' },
  className: { fontSize: 14, color: '#666' },
  emptyState: { flex: 1, justifyContent: 'center', alignItems: 'center', padding: 40 },
  emptyText: { fontSize: 18, fontWeight: '600', color: '#666', marginBottom: 8 },
  emptySubtext: { fontSize: 14, color: '#999' },
  fab: { position: 'absolute', right: 20, bottom: 20, width: 56, height: 56, borderRadius: 28, backgroundColor: '#712B13', justifyContent: 'center', alignItems: 'center', elevation: 6 },
