...
type NavigationProp = AdminStackNavigationProp<'Dashboard'>;

export default function DashboardScreen() {
  const navigation = useNavigation<NavigationProp>();

  const menuItems = [
    { title: 'Sınıflar', icon: '🏫', screen: 'ClassList' as const, color: '#0C447C' },
    { title: 'Çocuklar', icon: '👶', screen: 'ChildList' as const, color: '#712B13' },
    { title: 'Öğretmenler', icon: '👩‍', screen: 'TeacherList' as const, color: '#633806' },
    { title: 'Duyurular', icon: '📢', screen: 'AnnouncementList' as const, color: '#27500A' },
  ];
